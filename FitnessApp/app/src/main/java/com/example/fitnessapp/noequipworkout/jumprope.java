...
public class jumprope extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Jump rope Workout");
        ...
        countDownTimer = new CountDownTimer(121000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(jumprope.this, "FINISH", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(jumprope.this, burpees.class);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(jumprope.this, "TIME START", Toast.LENGTH_SHORT).show();
