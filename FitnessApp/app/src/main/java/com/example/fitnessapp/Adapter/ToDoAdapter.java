...
import com.example.fitnessapp.AddNewTask;
import com.example.fitnessapp.Mode.ToDoMode;
import com.example.fitnessapp.Planner;
...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.MyViewHolder> {
    ...
    public ToDoAdapter(DataBasaHelper myDB, Planner activity){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.planner_layout, parent, false);
