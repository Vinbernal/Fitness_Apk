...
public class highknees extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_highknees);

        getSupportActionBar().setTitle("High Knees Workout");
        ...
        countDownTimer = new CountDownTimer(121000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(highknees.this, "FINISH", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(highknees.this, divepushups.class);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(highknees.this, "TIME START", Toast.LENGTH_SHORT).show();
