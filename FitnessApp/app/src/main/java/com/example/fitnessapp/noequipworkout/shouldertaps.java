...
public class shouldertaps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Shoulder Taps Workout");
        ...
        countDownTimer = new CountDownTimer(61000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(shouldertaps.this, "FINISH", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(shouldertaps.this, crosscrunches.class);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(shouldertaps.this, "TIME START", Toast.LENGTH_SHORT).show();
