...
public class Supermanplanks extends AppCompatActivity {
...
//two parameter
        countDownTimer = new CountDownTimer(61000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(Supermanplanks.this, "FINISH", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Supermanplanks.this, burpees.class);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Supermanplanks.this, "TIME START", Toast.LENGTH_SHORT).show();
                countDownTimer.start();

            }
        });
//button next to burpees
